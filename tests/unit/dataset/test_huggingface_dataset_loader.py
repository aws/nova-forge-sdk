...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("stanfordnlp/imdb", "hf://datasets/stanfordnlp/imdb"),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ("squad", None, "hf://squad"),
        ("squad", "train", "hf://squad/train"),
        ("hf://datasets/squad", None, "hf://datasets/squad"),
        ("hf://datasets/squad", "train", "hf://datasets/squad/train"),
