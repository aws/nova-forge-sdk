...
class TestMLflowMonitor(unittest.TestCase):
    ...
    def test_mlflow_monitor_explicit_tracking_uri(self, mock_validate):
        ...
        monitor = MLflowMonitor(
            tracking_uri="arn:aws:sagemaker:us-west-2:123456789012:mlflow-app/app-CUSTOM"
        )

        # Verify configuration
        self.assertEqual(
            monitor.tracking_uri,
            "arn:aws:sagemaker:us-west-2:123456789012:mlflow-app/app-CUSTOM",
        )
    ...
    def test_mlflow_monitor_override_default_discovery(
        ...
        # Create monitor with explicit URI
        monitor = MLflowMonitor(
            tracking_uri="arn:aws:sagemaker:us-west-2:123456789012:mlflow-app/app-EXPLICIT"
        )
        ...
        self.assertEqual(
            monitor.tracking_uri,
            "arn:aws:sagemaker:us-west-2:123456789012:mlflow-app/app-EXPLICIT",
        )
