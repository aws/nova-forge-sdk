...
class TestCreateSagemakerInvokeRole(unittest.TestCase):
    ...
    # ------------------------------------------------------------------ #
    # 1. Role creation when it doesn't exist
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 2. Idempotent when role already exists
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 3. Policy scoping for non-wildcard s3 and glue resources
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 5. Policy already exists → update and attach
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 6. Unexpected error during role creation raises
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 7. Unexpected error during policy creation raises
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
    ...
    # ------------------------------------------------------------------ #
    # 8. All three expected policies are created
    # ------------------------------------------------------------------ #
    @patch("boto3.client")
